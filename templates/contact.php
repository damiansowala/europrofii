                ...
                <div class="col-xs-12 col-sm-8 page__body">
                    <div class="row m50">
                        ...
                        <div class="col-xsd-12 col-sm-6">
                            ...
                            <button id="modal-call" class="btn btn__more btn__more--red">Zamów rozmowę</button>
                            <button id="modal-message" class="btn btn__more btn__more--red">Napisz do nas</button>
                        </div>
                    </div>
        ...
        <div id="call" class="modal">
            ...
            <div class="container">
                ...
                <div class="col-xs-12 col-sm-12">
                        ...
                        <?php echo do_shortcode( ''. get_field('zamow_rozmowe') .'' ); ?>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-12 col-sm-12">
                        ...
                        <?php echo do_shortcode( ''. get_field('napisz_do_nas') .'' ); ?>
                    </div>
                </div>
            </div>
        </div>
