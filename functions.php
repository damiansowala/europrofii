<?php
	...
	register_nav_menus(array('offer-menu' => 'Menu offer'));
	register_nav_menus(array('footer-menu-1' => 'Footer 1'));
	register_nav_menus(array('footer-menu-2' => 'Footer 2'));
	register_nav_menus(array('footer-menu-3' => 'Footer 3'));
	register_nav_menus(array('footer-menu-4' => 'Footer 4'));
	...
	function modify_read_more_link() {
		return '<a class="btn btn__more btn__more--red" href="' . get_permalink() . '">Poczytaj więcej</a>';
	}
